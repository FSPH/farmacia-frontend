...
- Gerado em: 2026-06-04T01:40:52.616Z
- OpenAPI: 3.0.3
...
- `depo_id`: integer, obrigatorio. ID do deposito.
- `depo_descr`: string, obrigatorio. Descricao do deposito.
- `depo_ativo`: integer (0, 1), obrigatorio. Indicador de status ativo.
